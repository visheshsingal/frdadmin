    ...
    return (
        <div className='min-h-screen flex items-center justify-center w-full bg-white'>
            <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md border border-gray-200'>
                <h1 className='text-2xl font-bold mb-4 text-[#052659] text-center'>Admin Panel</h1>
                <form onSubmit={onSubmitHandler}>
                    ...
                    <button
                        className='mt-2 w-full py-2 px-4 rounded-md text-white bg-[#052659] hover:bg-[#041d47] transition'
                        type="submit"
                    >
                        Login
                    </button>
